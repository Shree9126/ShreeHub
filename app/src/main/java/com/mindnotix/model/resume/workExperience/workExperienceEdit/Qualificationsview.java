...
public class Qualificationsview{
  ...
  @SerializedName("organization_category_id")
  @Expose
  ...
  public void setOrganization_category_id(String organization_category_id){
   this.organization_category_id=organization_category_id;
  }
  public String getOrganization_category_id(){
   return organization_category_id;
  }
