...
public class EducationResumeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static String QualifiactionId = " ";
        ...
        spTitleQualification.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!titleId.equals("0")) {
                    ...
                    if (titleOfQualifiactionId.equals("-1")||titleOfQualifiactionId.equals("-2")) {
    ...
    private void loadProviderId(String regionalId, String organizationId) {
        ...
        progressDialog = Utils.createProgressDialog(EducationResumeActivity.this);
        ...
        loadProvider.enqueue(new Callback<Provider>() {
            ...
            public void onResponse(@NonNull Call<Provider> call, @NonNull Response<Provider> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    ...
                    Toast.makeText(EducationResumeActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(EducationResumeActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(EducationResumeActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(EducationResumeActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(EducationResumeActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(EducationResumeActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(EducationResumeActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void loadQualifiactionProviderSpinner() {
        ...
        providerArrayList.add(provider_ids);

        Collections.reverse(providerArrayList);


        ArrayAdapter<Provider_ids> regionalsArrayAdapter = new ArrayAdapter<Provider_ids>(EducationResumeActivity.this,
    ...
    private void loadTitleArrayalist() {
        ...
        titleArrayList.add(qualification);

        Collections.reverse(titleArrayList);


        ArrayAdapter<Qualification> regionalsArrayAdapter = new ArrayAdapter<>(EducationResumeActivity.this,
    ...
    private void loadRegionSpinner() {
        ...
        regionalsArrayList.add(regionals);

        //region load

        ArrayAdapter<Regionals> regionalsArrayAdapter = new ArrayAdapter<Regionals>(EducationResumeActivity.this,
    ...
    private void loadQualifiactionSpinner() {
        ...
        qualificationcategoryArrayList.add(qualificationcategory);

        //qualification load


        ArrayAdapter<Qualificationcategory> qualificationcategoryArrayAdapter = new ArrayAdapter<Qualificationcategory>(EducationResumeActivity.this,
    ...
    private void nceaSpinner() {
        ...
        nceAlevelsArrayList.add(nceAlevel);

        //ncea  load


        ArrayAdapter<NCEAlevel> nceAlevelArrayAdapter = new ArrayAdapter<NCEAlevel>(EducationResumeActivity.this,
    ...
    private void organizationSpinner() {
        ...
        organizationcategoryArrayList.add(organizationcategory);

        //organization load


        ArrayAdapter<Organizationcategory> organizationcategoryArrayAdapter =
                new ArrayAdapter<Organizationcategory>(EducationResumeActivity.this,
                ...
                try {
                    ...
                    if (response.code() == 200 || response.code() == 201) {
                        ...
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Toast.makeText(EducationResumeActivity.this, "failed to add work experience", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void calendar() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(EducationResumeActivity.this, date, myCalendar
    ...
    private void showChangeLangDialog() {
        ...
        final Dialog dialog = new Dialog(EducationResumeActivity.this);
        ...
        EntryAdapter entryAdapter = new EntryAdapter(EducationResumeActivity.this, items, "resume");
