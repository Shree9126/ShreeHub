...
public class LanguagesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_languages_skills);

        initalizeVar();

        if (getIntent() != null) {
            if (getIntent().getStringExtra("update").equals("1")) {
                edLaungages.setText(getIntent().getStringExtra("title"));
    ...
    private void initalizeVar() {
        ...
        edLaungages = findViewById(R.id.edLaungages);
...
//        recyclerTechnicalSkills.setAdapter(technicalSkillsAddAdapter);
    ...
    private void validate() {
        ...
        if(!edLaungages.getText().toString().trim().isEmpty())
        {
    ...
    private void addTechnicalSkills() {
        ...
        data.put("title", edLaungages.getText().toString());
        data.put("type", "3");
        ...
        progressDialog = Utils.createProgressDialog(LanguagesActivity.this);
            ...
            public void onResponse(@NonNull Call<Volunteer> call, @NonNull Response<Volunteer> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    ...
                    if (volunteer.getStatus().equals("1")) {
                        ...
                        Toast.makeText(LanguagesActivity.this, volunteer.getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else if (response.code() == 304) {

                    Toast.makeText(LanguagesActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(LanguagesActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(LanguagesActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(LanguagesActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(LanguagesActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(LanguagesActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(LanguagesActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
