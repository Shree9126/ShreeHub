...
public class DashboardMyStep extends Fragment implements View.OnClickListener {
        ...
        dialogBuilder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                if (dataPostTagListArrayList.size() != 0) {
                    ...
                    if (txtCustomTagsss.length() > 0 && txtCustomTagsss.charAt(txtCustomTagsss.length() - 1) == ',') {
                        txtCustomTagsss = txtCustomTagsss.substring(0, txtCustomTagsss.length() - 1);
                    }
    ...
    private void UiInitalization(View view) {

        this.btnCreatePost = (Button) view.findViewById(R.id.btnCreatePost);
        this.btnCreatePost.setOnClickListener(this);

        this.linearPickVideos = (LinearLayout) view.findViewById(R.id.linearPickVideos);
        this.linearPickVideos.setOnClickListener(this);
        this.linearPickCamera = (LinearLayout) view.findViewById(R.id.linearPickCamera);
        this.linearPickCamera.setOnClickListener(this);

        this.linearPickImages = (LinearLayout) view.findViewById(R.id.linearPickImages);
        ...
        this.linearAddTags = (LinearLayout) view.findViewById(R.id.linearAddTags);
        this.linearAddTags.setOnClickListener(this);

        this.linearPickTags = (LinearLayout) view.findViewById(R.id.linearPickTags);
        this.linearPickTags.setOnClickListener(this);

        this.linearCustomTagsList = (LinearLayout) view.findViewById(R.id.linearCustomTagsList);
        this.linearCustomTagsList.setOnClickListener(this);

        this.linearTags = (LinearLayout) view.findViewById(R.id.linearTags);
        //this.addTags = (LinearLayout) findViewById(R.id.addTags);
        this.edtAddTags = (EditText) view.findViewById(R.id.edtAddTags);


        this.tagEvents = (TextView) view.findViewById(R.id.tagEvents);
        this.tagEvents.setOnClickListener(this);
        this.txtCustomTag = (TextView) view.findViewById(R.id.txtCustomTag);

        this.tagMyInterest = (TextView) view.findViewById(R.id.tagMyInterest);
        this.tagMyInterest.setOnClickListener(this);
        this.tagCommunity = (TextView) view.findViewById(R.id.tagCommunity);
        this.tagCommunity.setOnClickListener(this);

        this.tagNewCreate = (TextView) view.findViewById(R.id.tagNewCreate);
        this.tagNewCreate.setOnClickListener(this);
        this.tagAddCustomTag = (TextView) view.findViewById(R.id.tagAddCustomTag);
        this.tagAddCustomTag.setOnClickListener(this);


        this.tagVolunteering = (TextView) view.findViewById(R.id.tagVolunteering);
        this.tagVolunteering.setOnClickListener(this);
        this.tagEmployment = (TextView) view.findViewById(R.id.tagEmployment);
        this.tagEmployment.setOnClickListener(this);
        this.tagTraining = (TextView) view.findViewById(R.id.tagTraining);
        this.tagTraining.setOnClickListener(this);
        this.tagEducation = (TextView) view.findViewById(R.id.tagEducation);
        this.tagEducation.setOnClickListener(this);
        this.txtAddNewTag = (TextView) view.findViewById(R.id.txtAddNewTag);
        this.txtAddNewTag.setOnClickListener(this);
        this.linearImages = (LinearLayout) view.findViewById(R.id.linearImages);
        this.recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView);
        this.recyclerViewCustomTagList = (RecyclerView) view.findViewById(R.id.recyclerViewCustomTagList);
        this.recyclerViewCustomTagList.setLayoutManager(new LinearLayoutManager(getActivity()));
        this.linearCameraImages = (LinearLayout) view.findViewById(R.id.linearCameraImages);
        this.imgTakeImage = (ImageView) view.findViewById(R.id.imgTakeImage);
        this.image_view = (ImageView) view.findViewById(R.id.image_view);
        this.linearCameraVideo = (LinearLayout) view.findViewById(R.id.linearCameraVideo);
        this.imgVideoImageThumbnail = (ImageView) view.findViewById(R.id.imgVideoImageThumbnail);
        this.edtPost = (EditText) view.findViewById(R.id.edtPost);
        this.imgProfileImage = (CircleImageView) view.findViewById(R.id.imgProfileImage);
        this.toolbar = (Toolbar) view.findViewById(R.id.toolbar);
        this.toolbar.setVisibility(View.GONE);
        this.addNewTagView = view.findViewById(R.id.addNewTagView);
        ...
        switch (v.getId()) {
            ...
            case R.id.txtAddNewTag:
                if (!Utils.hasText(edtAddTags)) {
                    Toast.makeText(getActivity(), "Enter your tag", Toast.LENGTH_SHORT).show();
                } else {
                    addTags();
                }
            ...
            case R.id.tagAddCustomTag:
                // linearTags.setGravity(Gravity.START);
                //  linearCustomTagsList.setVisibility(View.GONE);
            ...
            case R.id.btnCreatePost:
                ...
                if (tags_id.equals("")) {
                    Toast toast = Toast.makeText(getActivity(), "Select tags regard your post", Toast.LENGTH_LONG);
                    ...
                    if (!pm_description.equals("")) {
                        ...
                        Toast.makeText(getActivity(), "Enter description regard your post", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onResponse(Call<DataDashboardTimeLine> call, Response<DataDashboardTimeLine> response) {
                ...
                if (response.code() == 200) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Intent mIntent = new Intent(getActivity(), NavDrawerActivity.class);
                        startActivity(mIntent);
                        /*Intent mIntent = new Intent(CreatePostActivity.this, DashBoardActivity.class);
                        startActivity(mIntent);*/
                        Toast.makeText(getActivity(), "You have post successfully!", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(getActivity(), "You have post failure!", Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            ...
            case CAMERA_REQUEST:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Log.d(TAG, "onActivityResult: selectedImage realPath " + realPath);
                    // progressDialog = Utils.createProgressDialog(getActivity());
            ...
            case Constant.REQUEST_CODE_PICK_IMAGE:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    for (ImageFile file : list) {
                        ...
                        final String str = CompressImage.getInstance().compressImage(getActivity(), path);
    ...
    private void addThemToView(ArrayList<String> imagePaths, String path_thumb) {
        ...
        if (filePaths.size() == 1) {
            ...
            if (recyclerView != null) {
                ...
                imageAdapter = new ImageAdapter(getActivity(), filePaths, listener, "2", path_thumb);
                    ...
                    try {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            ...
                            if (response.body().getStatus().equals("1")) {
                                ...
                                if (failedSize > 0)
                                    Toast.makeText(getActivity(), "Some files are failed to upload. Try again later", Toast.LENGTH_SHORT).show();
