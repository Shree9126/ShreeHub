...
public class AppliedListFragmet extends Fragment {

    ProgressBar progressBar;
    View progressLayout;
    ArrayList<AppliedList> appliedLists;
    AppliedListAdapter appliedListAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_applied_list_fragment, container, false);
        intiUi(view);
        return view;
    }
                    ...
                    if (basicResponse.getStatus().equals("1")) {
                        ...
                        try {
                            ...
                            if (!basicResponse.getData().getApplied_list_count().equals("0")
                                ...
                                appliedListAdapter = new AppliedListAdapter(getActivity(), appliedLists);
