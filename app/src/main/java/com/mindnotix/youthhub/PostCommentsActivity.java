...
public class PostCommentsActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    ArrayList<Tweaks> tweaksArrayListLoad = new ArrayList<Tweaks>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postCommentsAdapter = new PostCommentsAdapter(PostCommentsActivity.this, tweaksArrayList, listener);
    ...
    public void DeleteDilaog(final int adapterPosition) {
        ...
        txtTitle_head.setText("Remove comment");
        ...
        /*  final Dialog dialog = new Dialog(PostCommentsActivity.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(false);
            ...
            public void onResponse(Call<DataLikeCommentsContriubes> call, Response<DataLikeCommentsContriubes> response) {
                ...
                if (response.body().getStatus().equals("1")) {
                    ...
                    Events.ActivityRefreshCommandsContributeCount activityRefreshCommandsCount =
                            new Events.ActivityRefreshCommandsContributeCount(1, position, "3");

                    GlobalBus.getBus().postSticky(activityRefreshCommandsCount);


                    Toast.makeText(PostCommentsActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(PostCommentsActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void getContributes(String post_id, String nextPages) {
      ...
      /*  progressDialog = Utils.createProgressDialog(this);*/
        ...
        Log.d(TAG, "getContributes: next pages " + nextPages);
        ...
        call.enqueue(new Callback<DataLikeCommentsContriubes>() {
            ...
            public void onResponse(Call<DataLikeCommentsContriubes> call, Response<DataLikeCommentsContriubes> response) {
                ...
                if (response.body().getStatus().equals("1")) {
                    ...
                    int sizes = tweaksArrayList.size();
    ...
    private void UiInitialization() {
        ...
        this.commenttext.setHint("Write a comment...");
    ...
    private class SendCommands extends AsyncTask<Void, Void, String> {
        ...
        PostCommentsActivity postContributeActivity;
        String comments;

        public SendCommands(PostCommentsActivity postContributeActivity, String comments) {
...
*/
                        ...
                        Events.ActivityRefreshCommandsContributeCount activityRefreshCommandsCount =
                                new Events.ActivityRefreshCommandsContributeCount(1, position, "0");
