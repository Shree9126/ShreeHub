...
/**
 * Created by Sridharan on 3/1/2018.
 */

public class FragmentProfileSeeMyStep extends Fragment implements IBaseResponseListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = FragmentProfileSeeMyStep.class.getSimpleName();
            ...
            public void onClick(final View view, final int position) {
                ...
                switch (view.getId()) {
                    ...
                    case R.id.imgComments:
                      ...
                      /*  LinearLayout linearLayout = view.findViewById(R.id.linear_comments);
                    ...
                    case R.id.linear_comments:
                      ...
                      /*  LinearLayout linearLayout = view.findViewById(R.id.linear_comments);
                        ...
                        Intent comments = new Intent(getActivity(), PostCommentsActivity.class);
                        comments.putExtra("post_id", dataArrayList.get(position).getPosts().getPmPostId());
                        comments.putExtra("position", position);
                    ...
                    case R.id.linear_contribute:
                        ...
                        Intent contributes = new Intent(getActivity(), PostContributeActivity.class);
                        contributes.putExtra("post_id", dataArrayList.get(position).getPosts().getPmPostId());

                        contributes.putExtra("position", position);
                        startActivity(contributes);
                        break;
                    ...
                    case R.id.image5:
                        ...
                        image5.putExtra("position", position);
                    ...
                    case R.id.image3:
                        ...
                        image3.putExtra("position", position);
                    ...
                    case R.id.image2:
                        ...
                        image2.putExtra("position", position);
                    ...
                    case R.id.image1:
                        ...
                        image1.putExtra("position", position);
    ...
    void showPopupWindowMypost(final View view, final int position) {
        ...
        if (dataArrayList.get(position).getPosts().getPmStep().equals("1") &&
                dataArrayList.get(position).getPosts().getPmTimeline().equals("1")) {
            popup.getMenu().getItem(2).setTitle("Hide from step");
            popup.getMenu().getItem(2).setIcon(R.drawable.ic_ban_circle_symbol);
        } else if (dataArrayList.get(position).getPosts().getPmStep().equals("1") &&
                dataArrayList.get(position).getPosts().getPmTimeline().equals("0")) {
            popup.getMenu().getItem(2).setTitle("Show in timeline");
            popup.getMenu().getItem(2).setIcon(R.drawable.ic_show_in_timeline);
        }
        if (dataArrayList.get(position).getPostUserActivity().getIs_favour_user().equals("1"))
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                } else if (item.getTitle().equals("Hide from step")) {


                    RemoveTimelineDilaog(position, "Hide from step");
                } else if (item.getTitle().equals("Show in timeline")) {


                    ShowTimelineDilaog(position, "Show in timeline");
                }
                return true;
    ...
    private void RemoveFromStep(final int position, String status) {
    ...
    private void HideFromTimeLine(final int position, String status) {
        progressDialog = Utils.createProgressDialog(getActivity());

        Map<String, String> data = new HashMap<>();
        data.put("postid", dataArrayList.get(position).getPosts().getPmPostId());
        data.put("stepid", "1");
        data.put("timelineid",status);
    ...
    public void ShowTimelineDilaog(final int adapterPosition, String s) {
        ...
        txtTitle.setText(s);
        txtTitle.setAllCaps(false);
        text_dialog.setText("Are you sure want to show in timeline?");
        Button btOkay = dialog.findViewById(R.id.btOkay);
        ImageView imageView = dialog.findViewById(R.id.imgRegpply);
        ...
        btOkay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                HideFromTimeLine(adapterPosition,"1");
    ...
    public void RemoveTimelineDilaog(final int adapterPosition, String s) {
        ...
        txtTitle.setText(s);
        txtTitle.setAllCaps(false);
        text_dialog.setText("Are you sure want to hide from step?");
        Button btOkay = dialog.findViewById(R.id.btOkay);
        ImageView imageView = dialog.findViewById(R.id.imgRegpply);
        ...
        btOkay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RemoveFromStep(adapterPosition, "0");
