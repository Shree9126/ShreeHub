...
public class FindConnectionServiceProviderActivity extends BaseActivity implements View.OnClickListener,
        SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG = FindConnectionServiceProviderActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_connection_service_provider);
        ...
        swipeRefreshLayout.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        NextPage = "";
                                        getServiceProviderFindConnectionList();
                                    }
                                }
        );
    }
            ...
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindConnectionServiceProviderActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(FindConnectionServiceProviderActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindConnectionServiceProviderActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void getServiceProviderFindConnectionList() {
        ...
        data.put("ysppartner_type", service_type_ids);
        data.put("partner_tag", tags_ids);
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindConnectionServiceProviderActivity.this, listener);
                            ...
                            // Toast.makeText(FindConnectionServiceProviderActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2) {
            ...
            if (data != null) {
                ...
                service_type_ids = data.getStringExtra("service_type_ids");
                tags_ids = data.getStringExtra("tags_ids");

                Log.d(TAG, "onActivityResult: regional_ids " + regional_ids);
                swipeRefreshLayout.setRefreshing(true);
                getServiceProviderFindConnectionList();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fab:
                Intent mIntent = new Intent(FindConnectionServiceProviderActivity.this, FindConnectionServiceProviderFilter.class);
                mIntent.putExtra("name", "Service Providers");
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindConnectionServiceProviderActivity.this);
