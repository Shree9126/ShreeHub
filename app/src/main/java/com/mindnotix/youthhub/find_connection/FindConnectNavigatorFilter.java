...
public class FindConnectNavigatorFilter extends BaseActivity implements View.OnClickListener {
...
*/
            ...
            public void onResponse(Call<DataFindConnectionMaster> call, Response<DataFindConnectionMaster> response) {
                ...
                if (response.code() == 200) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindConnectNavigatorFilter.this, "No record available", Toast.LENGTH_SHORT).show();
                    }
                } else if (response.code() == 304) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindConnectNavigatorFilter.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindConnectNavigatorFilter.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void UiInitialization() {
        ...
        this.linearWhishlist = (LinearLayout) findViewById(R.id.linearWhishlist);
        this.linearWhishlist.setVisibility(View.GONE);
        this.linearSpnrWishlist.setVisibility(View.GONE);
        ...
        this.txtjosss.setText("Browse Navigators");
        ...
        try {
            ...
            getSupportActionBar().setTitle("Navigators Filter");
    ...
    private void showWishListDialog() {
        ...
        filterText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                alertdialogAdapter.search(s.toString());
            }
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
              ...
              /*  String display_checked_days = "";
                ...
                for (int i = 0; i < wishlistArrayList.size(); i++) {
                    if (wishlistArrayList.get(i).getStatus().equals("1")) {
                        display_checked_days = display_checked_days + "," + wishlistArrayList.get(i).getName();
                        display_checked_id = display_checked_id + "," + wishlistArrayList.get(i).getId();
                        Log.d(TAG, "onClick: " + display_checked_id);
                        Log.d(TAG, "onClick: " + display_checked_days);
                        display_checked_job_wishlist = display_checked_days.substring(1, display_checked_days.length());
                        display_checked_job_wishlist_id = display_checked_id.substring(1, display_checked_id.length());
                        Log.d(TAG, "onClick:s " + display_checked_job_wishlist);
                        Log.d(TAG, "onClick:s " + display_checked_job_wishlist_id);
                    }
                }
        ...
        filterText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
               ...
               /* wishlistArrayTempList.clear();
                ...
                FindDistrictLocalBoardAdapter alertdialogAdapter = new FindDistrictLocalBoardAdapter(wishlistArrayTempList, FindConnectNavigatorFilter.this);
                recyclerView.setAdapter(alertdialogAdapter);*/
