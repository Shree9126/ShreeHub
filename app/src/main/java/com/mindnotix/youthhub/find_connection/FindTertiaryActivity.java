...
public class FindTertiaryActivity extends BaseActivity implements View.OnClickListener,
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindTertiaryActivity.this);
                ...
                public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                    ...
                    if (response.code() == 200 || response.code() == 201) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Toast.makeText(FindTertiaryActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                        } else {
                        ...
                        Toast.makeText(FindTertiaryActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                    } else if (response.code() == 400) {

                        Toast.makeText(FindTertiaryActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                    } else if (response.code() == 401) {

                        Toast.makeText(FindTertiaryActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                    } else if (response.code() == 403) {

                        Toast.makeText(FindTertiaryActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                    } else if (response.code() == 404) {

                        Toast.makeText(FindTertiaryActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                    } else if (response.code() == 422) {

                        Toast.makeText(FindTertiaryActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                    } else {

                        Toast.makeText(FindTertiaryActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void getTertiaryFindConnectionList() {
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindTertiaryActivity.this, listener);
                            ...
                            Toast.makeText(FindTertiaryActivity.this, "No record found", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
                ...
                try {
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Toast.makeText(FindTertiaryActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
    ...
    private void UiInitialization() {
        ...
        try {
            ...
            getSupportActionBar().setTitle("Tertiary");
...
/*                edtSearchTxt = data.getStringExtra("edtSearchTxt");
                ...
                Intent mIntent = new Intent(FindTertiaryActivity.this, FindConnectionServiceProviderFilter.class);
                mIntent.putExtra("name","Tertiary");
