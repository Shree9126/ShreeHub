...
public class FindTeachersActivity extends BaseActivity implements View.OnClickListener,
            ...
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindTeachersActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(FindTeachersActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindTeachersActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindTeachersActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindTeachersActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindTeachersActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindTeachersActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindTeachersActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void getTeachersFindConnectionList() {
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindTeachersActivity.this, listener);
                            ...
                            Toast.makeText(FindTeachersActivity.this, "No record found", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
                ...
                try {
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Toast.makeText(FindTeachersActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fab:
                ...
                Intent mIntent = new Intent(FindTeachersActivity.this, FindConnectionServiceProviderFilter.class);
                mIntent.putExtra("name", "Teachers");
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindTeachersActivity.this);
