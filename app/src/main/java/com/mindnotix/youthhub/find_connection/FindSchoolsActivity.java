...
public class FindSchoolsActivity extends BaseActivity implements View.OnClickListener,
            ...
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindSchoolsActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(FindSchoolsActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindSchoolsActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindSchoolsActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindSchoolsActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindSchoolsActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindSchoolsActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindSchoolsActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindSchoolsActivity.this, listener);
                            ...
                            Toast.makeText(FindSchoolsActivity.this, "No record found", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
                ...
                try {
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            Toast.makeText(FindSchoolsActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fab:
                ...
                Intent mIntent = new Intent(FindSchoolsActivity.this, FindConnectionServiceProviderFilter.class);
                mIntent.putExtra("name", "Schools");
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindSchoolsActivity.this);
