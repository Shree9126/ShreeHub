...
public class FindConnectinYouthActivity extends BaseActivity implements View.OnClickListener,
            ...
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindConnectinYouthActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(FindConnectinYouthActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindConnectinYouthActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindConnectinYouthActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindConnectinYouthActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindConnectinYouthActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindConnectinYouthActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindConnectinYouthActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
...
/*                Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                Intent mIntent = new Intent(FindConnectinYouthActivity.this, FindConnectYouthFilter.class);
                ...
                mIntent.putExtra("wishlist_ids",wishlist_ids);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2) {
            ...
            if (data != null) {
                ...
                wishlist_ids = data.getStringExtra("wishlist_ids");
                swipeRefreshLayout.setRefreshing(true);
                getYouthFindConnectionList();
            } else {
                district_ids = "";
    ...
    private void getYouthFindConnectionList() {
        ...
        data.put("wishlist", wishlist_ids);
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindConnectinYouthActivity.this, listener);
                            ...
                            Toast.makeText(FindConnectinYouthActivity.this, "No record found", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
                    ...
                    try {
                        ...
                        if (response.code() == 200) {
                            if (response.body().getStatus().equals("1")) {
                                ...
                                Toast.makeText(FindConnectinYouthActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                            }
                        } else if (response.code() == 304) {
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindConnectinYouthActivity.this);
