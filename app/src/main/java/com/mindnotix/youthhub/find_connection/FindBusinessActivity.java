...
public class FindBusinessActivity extends BaseActivity implements View.OnClickListener,
            ...
            public void onResponse(Call<BasicResponse> call, Response<BasicResponse> response) {
                ...
                if (response.code() == 200 || response.code() == 201) {
                    if (response.body().getStatus().equals("1")) {
                        ...
                        Toast.makeText(FindBusinessActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(FindBusinessActivity.this, "304 Not Modified", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 400) {

                    Toast.makeText(FindBusinessActivity.this, "400 Bad Request", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 401) {

                    Toast.makeText(FindBusinessActivity.this, "401 Unauthorized", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 403) {

                    Toast.makeText(FindBusinessActivity.this, "403 Forbidden", Toast.LENGTH_SHORT).show();
                } else if (response.code() == 404) {

                    Toast.makeText(FindBusinessActivity.this, "404 Not Found", Toast.LENGTH_SHORT).show();

                } else if (response.code() == 422) {

                    Toast.makeText(FindBusinessActivity.this, "422 Unprocessable Entity", Toast.LENGTH_SHORT).show();

                } else {

                    Toast.makeText(FindBusinessActivity.this, "500 Internal Server Error", Toast.LENGTH_SHORT).show();
    ...
    private void getBusinessFindConnectionList() {
        ...
        data.put("partner_type", service_type_ids);
        data.put("partner_subtype", service_type_ids);
                    ...
                    if (response.code() == 200) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            youthFindConnectionAdapter = new YouthFindConnectionAdapter(
                                    youthUserinfoArrayList, FindBusinessActivity.this, listener);
                            ...
                            Toast.makeText(FindBusinessActivity.this, "No record found", Toast.LENGTH_SHORT).show();
                        }
                    } else if (response.code() == 304) {
                    ...
                    try {
                        ...
                        if (response.code() == 200) {
                            if (response.body().getStatus().equals("1")) {
                                ...
                                Toast.makeText(FindBusinessActivity.this, "No record available", Toast.LENGTH_SHORT).show();
                            }
                        } else if (response.code() == 304) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2) {
            ...
            if (data != null) {
                ...
                sub_service_type_ids = data.getStringExtra("sub_service_type_ids");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fab:
                ...
                Intent mIntent = new Intent(FindBusinessActivity.this, FindBusinessFilter.class);
                mIntent.putExtra("name", "Business");
                ...
                mIntent.putExtra("sub_service_type_ids", sub_service_type_ids);
    ...
    public class UnFollowEvent extends AsyncTask<Void, Void, String> {
        ...
        public UnFollowEvent(int position, View view, String status) {
            ...
            this.view = view;
            this.status = status;
            progressDialog = Utils.createProgressDialog(FindBusinessActivity.this);
