...
import com.mindnotix.youthhub.cvresume.addExtraActivites.LanguagesActivity;
...
public class LanguagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LanguagesAdapter(Context context, ArrayList<Languages> languages) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_resume_languages_item, parent, false);
    ...
    private Languages getItem(int position) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            Languages languages = getItem(position - 1);
            GenericViewHolder genericViewHolder = (GenericViewHolder) holder;


            genericViewHolder.tvTitle.setText(languages.getName());
    ...
    class GenericViewHolder extends RecyclerView.ViewHolder {
        ...
        public GenericViewHolder(View itemView) {
            ...
            viewDelete.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Languages languages = getItem(getAdapterPosition() - 1);
                    deleteConfirmationDilaog(languages.getId()
                            ,context,
            ...
            viewIndividual.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Languages languages = getItem(getAdapterPosition() - 1);
                    Intent intent = new Intent(context, LanguagesActivity.class);
                    intent.putExtra("title",languages.getName());
                    intent.putExtra("id",languages.getId());
                ...
                if (response.code() == 200 || response.code() == 201) {
                    ...
                    if (extraActivities.getStatus().equals("1")) {
                        try {
                            ...
                            languages.remove(adapterPosition);
