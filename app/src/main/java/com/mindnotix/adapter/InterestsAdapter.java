...
import com.mindnotix.model.loadResume.Interests;
...
public class InterestsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Context context;
    ArrayList<Interests> technicalskills;

    public InterestsAdapter(Context context, ArrayList<Interests> technicalskills) {
...
//            });
            ...
            Interests technicalskills = getItem(position - 1);
