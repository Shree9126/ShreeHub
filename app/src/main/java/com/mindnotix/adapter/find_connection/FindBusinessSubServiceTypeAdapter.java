...
public class FindBusinessSubServiceTypeAdapter extends RecyclerView.Adapter<FindBusinessSubServiceTypeAdapter.MyViewHolder> {
    Activity activity;
    private ArrayList<Subcategoryview> regionalsArrayList;
    private ArrayList<Subcategoryview> regionalsArrayListTemp;

    public FindBusinessSubServiceTypeAdapter(ArrayList<Subcategoryview> regionalsArrayList, Activity activity) {
    ...
    public void search(String query) {
        ...
        for (Subcategoryview wishlist : regionalsArrayList) {
    ...
    public ArrayList<Subcategoryview> getModifyPartnerTagsList() {
