...
public class FindBusinessServiceTypeAdapter extends RecyclerView.Adapter<FindBusinessServiceTypeAdapter.MyViewHolder> {
    Activity activity;
    private ArrayList<Biz_partnertype> regionalsArrayList;
    private ArrayList<Biz_partnertype> regionalsArrayListTemp;

    public FindBusinessServiceTypeAdapter(ArrayList<Biz_partnertype> regionalsArrayList, Activity activity) {
    ...
    public void search(String query) {
        ...
        for (Biz_partnertype wishlist : regionalsArrayList) {
    ...
    public ArrayList<Biz_partnertype> getModifyServiceTypeList() {
